                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div id="gender" class="btn-group" data-toggle="buttons">
                                        ...
                                        <input type="radio" name="gender" value="Male" data-parsley-multiple="gender" @if($trainer['gender'] == 'Male') checked @endif> &nbsp; Male &nbsp;
                                        </label>
                                        <label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                        <input type="radio" name="gender" value="Female" data-parsley-multiple="gender" @if($trainer['gender'] == 'Female') checked @endif> Female
                                        </label>
                                    </div>
