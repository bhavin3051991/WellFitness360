	...
	<div class="right_col" role="main">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title">
						<h2>@lang('backend/list.forms.add_blog')</h2>
						<div class="clearfix"></div>
					</div>
					<div class="x_content">
						<br />
						<form id="blogForm" action="{{ url('blogManagement') }}"  method="post" class="form-horizontal form-label-left" enctype='multipart/form-data'>
							<input type="hidden" name="_token" value="{{ csrf_token() }} ">
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="title">Title <span class="required">*</span>
								</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="title" value="{{ old('title') }}" id="title" class="form-control col-md-7 col-xs-12" placeholder="Enter Title">
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" id="blogtag" name="blogtag" value="{{ old('blogtag') }}" class="form-control col-md-7 col-xs-12" placeholder="Enter Tag">
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="url_alias" id="url_alias" class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<textarea name="blog_desc" id="blog_desc" class="form-control col-md-7 col-xs-12" placeholder="Enter Description"></textarea>
