    ...
    <div class="right_col" role="main">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>@lang('backend/list.forms.add_subscription_plan')</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <br />
                        <form id="subscriptionPlan" action="{{ route('SubscriptionPlanManagement.store') }}"  method="post" class="form-horizontal form-label-left">
                                    ...
                                    <select id="Duration" name="Duration" class="form-control">
                                        ...
                                        @if($PlanDurations)
                                            @foreach ($PlanDurations as $Duration )
                                                <option value="{{$Duration->id}}" @if(old('Duration') == $Duration->id) selected @endif>{{ucwords($Duration->duration)}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="Amount" value="{{ old('Amount') }}" id="Amount" class="form-control col-md-7 col-xs-12" placeholder="Enter Plan Amount">
