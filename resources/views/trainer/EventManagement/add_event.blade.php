	...
	<div class="right_col" role="main">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title">
						<h2>@lang('backend/list.forms.add_event')</h2>
						<div class="clearfix"></div>
					</div>
					<div class="x_content">
						<br />
						<form id="eventForm" action="{{ url('eventManagement') }}"  method="post" class="form-horizontal form-label-left">
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="eventname" value="{{ old('eventname') }}" id="eventname" class="form-control col-md-7 col-xs-12" placeholder="Enter Event Name">
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="livecode" value="{{ $eventcode }}" id="livecode" class="form-control col-md-7 col-xs-12" readonly="readonly">
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" id="start_date" name="start_date" value="{{ old('start_date') }}" class="form-control col-md-7 col-xs-12" placeholder="Enter start date">
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="end_date" value="{{ old('end_date') }}" id="end_date" class="form-control col-md-7 col-xs-12" placeholder="Enter end date">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<select id="trainer" name="trainer[]" class="form-control" multiple="multiple">
										@foreach($users as $val)
											<option value="{{ $val['id'] }}">{{ $val['name'] }} {{ $val['sur_name'] }}</option>
										@endforeach
									</select>
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<textarea name="event_desc" id="event_desc" class="form-control col-md-7 col-xs-12" placeholder="Enter Event Description"></textarea>
